...
export async function createAbonnement(data, customId) {
...
export async function getAbonnements(includeArchived = false) {
  try {
...
export async function getAbonnement(id) {
  try {
...
export async function updateAbonnement(id, updates) {
  const userEmail = auth.currentUser?.email || 'admin';
  const payload = {
    ...updates,
...
export async function archiveAbonnement(id) {
...
export function subscribeAbonnements(callback, includeArchived = false) {
