...
import { getPaiements } from './paiements.js';

const COLLECTION_NAME = 'finances';

export async function createExpense(data, customId) {
...
export async function getExpenses(includeArchived = false) {
  try {
...
export async function calculateFinancialSummary(paymentsList, expensesList) {
